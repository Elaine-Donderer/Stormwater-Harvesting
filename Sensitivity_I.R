...
drainage_density_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Drain_I.tif")
aquifer_recharge_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Geo_I.tif")
rainfall_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Rain_I.tif")
land_use_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Land_I.tif")
soil_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Soil_I.tif")
slope_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Slope_I.tif")
roads_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Roads_I.tif")
wadis_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Wadis_I.tif")
population_density_layer <- raster("C:/Users/Elain/Downloads/Sensitivity_I/Pop_I.tif")
...
png("sensitivity_expert_100_I.png", width = 1200, height = 1000, res = 150)  # Set width, height, and resolution
par(mar = c(5, 5, 4, 2))  # Adjust the margins
plot(sensitivity_raster_expert, 
     main = "Sensitivity Map for I (Expert Weights)", 
     cex.main = 2)  # Larger title size for better visibility
dev.off()  # Close the PNG device

# Save the plot as a larger image
png("sensitivity_equal_100_I.png", width = 1200, height = 1000, res = 150)  # Set width, height, and resolution
par(mar = c(5, 5, 4, 2))  # Adjust the margins
plot(sensitivity_raster_equal, 
     main = "Sensitivity Map for I (Equal Weights)", 
     cex.main = 2)  # Larger title size for better visibility
dev.off()  # Close the PNG device

# Optional: Save the rasters to files if needed
writeRaster(sensitivity_raster_expert, "sensitivity_expert_I_100.tif", overwrite = TRUE)
writeRaster(sensitivity_raster_equal, "sensitivity_equal_I_100.tif", overwrite = TRUE)
...
ggsave("variance_comparison_I_100.png", plot = plot_variance, width = 10, height = 6, dpi = 300)
